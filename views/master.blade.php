...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('jai')}}" type="image/x-icon">
    <link rel="icon" href="{{asset('packages/Jai/backend/favicon.ico')}}" type="image/x-icon">
    ...
    <link href="{{asset("packages/Jai/backend/css/styles.css")}}" rel="stylesheet" type="text/css">
    <link href="{{asset("packages/Jai/backend/font-icon/icomoon/style.css")}}" rel="stylesheet" type="text/css">
    ...
    <script src="{{asset("packages/Jai/backend/js/jquery-1.11.0.js")}}"></script>
...
<script src="{{asset("jai")}}"></script>

<!-- Metis Menu Plugin JavaScript -->
<script src="{{asset("packages/Jai/backend/js/plugins/metisMenu/metisMenu.min.js")}}"></script>
<script type="text/javascript" src="{{asset("packages/Jai/backend/js/plugins/tinymce/tinymce.min.js")}}" ></script>
...
<script src="{{asset("packages/Jai/backend/js/sb-admin-2.js")}}"></script>
